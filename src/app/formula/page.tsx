...
import { Loader2, Sparkles, Wand2, Terminal, Lightbulb, Bot, FileText, BookCopy } from "lucide-react";
      ...
      <main className="grid flex-1 grid-cols-1 md:grid-cols-[280px_1fr] lg:grid-cols-[320px_1fr]">
        ...
        <aside className="hidden md:flex flex-col gap-4 border-r bg-background p-4">
            ...
            <div className="flex-1 space-y-4">
                ...
                <div className="text-center text-sm text-muted-foreground/60 p-4 border border-dashed rounded-lg">
                    ...
                    <CardContent className="relative">
                     ...
                     <CardFooter>
                       <Button type="submit" disabled={isLoading || isEnhancing} className="w-full sm:w-auto ml-auto bg-primary hover:bg-primary/90 text-primary-foreground shadow-lg shadow-primary/20">
                          ...
                          {isLoading ? "Generating..." : "Generate Formulas"}
                        </Button>
                     </CardFooter>
                </Card>
            </form>
